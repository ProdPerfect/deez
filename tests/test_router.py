...
from tests.mock_event import event_version_1, event_version_2
...
class RouterTestCase(unittest.TestCase):
    ...
    def test_can_route_correctly_version_1(self, *args, **kwargs):
        app = Deez()
        app.register_route(r'^/hello/world$', HelloWorldResource)
        response, status_code, _, _ = app.router.execute(event_version_1, {})
        self.assertEqual(json_dumps({'message': 'hello world'}), response)
        self.assertEqual(status_code, 200)

    def test_can_route_correctly_version_2(self, *args, **kwargs):
        app = Deez()
        app.register_route(r'^/hello/world$', HelloWorldResource)
        response, status_code, _, _ = app.router.execute(event_version_2, {})
        self.assertEqual(json_dumps({'message': 'hello world'}), response)
        self.assertEqual(status_code, 200)
    ...
    def test_can_route_correctly_with_str_path(self, *args, **kwargs):
        ...
        _event = copy.deepcopy(event_version_1)
    ...
    def test_router_selects_most_specific_route(self):
        event_version_1['path'] = '/hello/world/1000/1000'
        ...
        response, status_code, _, _ = self.router.execute(event_version_1, {})
        self.assertEqual(json_dumps({'message': 'hello world'}), response)
        self.assertEqual(status_code, 200)
    ...
    def test_user_provided_headers_are_returned_in_response(self):
        ...
        response = self.router.route(event_version_1, {})
    ...
    def test_raises_404_when_route_not_found(self):
        ...
        with self.assertRaises(NotFound) as e:
            self.router.execute(event_version_1, {})
